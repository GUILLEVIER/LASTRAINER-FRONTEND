    ...
    <div>
      ...
      <section className="w-full max-w-7xl mx-auto py-10 px-4">
        <div className="block sm:hidden relative">
          ...
          >
            <div className="relative rounded-xl overflow-hidden shadow-lg h-80 w-full flex flex-col items-end group cursor-pointer bg-black">
              ...
              <div className="p-6 flex flex-col items-center w-full flex-1">
                ...
                <p className="text-primary font-semibold text-xl mb-2">{products[current].price}</p>
        ...
        <div className="hidden sm:grid grid-cols-2 lg:grid-cols-4 gap-6">
          {products.map((product, idx) => (
            <div key={idx} className="relative rounded-xl overflow-hidden shadow-lg h-80 flex flex-col items-end group cursor-pointer bg-black">
