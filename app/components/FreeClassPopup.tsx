    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      ...
      <div className='bg-white/95 backdrop-blur-sm rounded-lg p-8 max-w-md w-full mx-4 relative z-10 shadow-2xl'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <button
            type='submit'
            className='w-full px-8 py-3 bg-black text-white font-semibold rounded-full shadow border border-white hover:bg-primary transition-colors duration-300 rounded-md'
          >
            SOLICITAR
          </button>
        </form>
