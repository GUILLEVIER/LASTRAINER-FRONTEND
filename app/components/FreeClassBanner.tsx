...
export function FreeClassBanner({ onClick }: FreeClassBannerProps) {
  return (
    <div 
      onClick={onClick}
      className="relative bg-gradient-to-r from-sky-500 via-indigo-500 to-[#1EE2E2] rounded-lg p-8 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-2xl overflow-hidden"
    >
