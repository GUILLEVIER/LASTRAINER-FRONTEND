      ...
      >
        ...
        <div className='relative z-10 w-full text-center pb-8'>
          <h2 className='text-3xl font-bold text-white mb-2 drop-shadow-lg'>
            Take The Quiz To Find The Best Program
          </h2>
          <p className='text-lg text-white mb-4 drop-shadow'>
            ¡Transform your performance!
          </p>
          <button className='px-6 py-2 bg-black text-white font-semibold rounded-full shadow border border-white hover:bg-primary transition'>
            START QUIZ
          </button>
        </div>
      </div>
